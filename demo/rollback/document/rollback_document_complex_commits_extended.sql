...
update structure somedocument_test where ( str == val111 ) modify [ str => val222, obj.field1 => val222, obj.field2 => 222 ];
select from structure somedocument_test where ( 1 == 1 ) fields [ _rid, str, obj.field1, obj.field2 ];

update structure somedocument_test where ( obj.field1 == val222 ) modify [ str => val333, obj.field1 => val333, obj.field2 => 333 ];
select from structure somedocument_test where ( 1 == 1 ) fields [ _rid, str, obj.field1, obj.field2 ];
