...
create tables from [ schema01, schema02 ] using format "%TypeName%_Table";

insert into schema02_Table objects [  
  { "str": "val11", "obj": { "field1": "val11", "field2": "11" } }  
  { "str": "val111", "obj": { "field1": "val111", "field2": "111" } }
  { "str": "val111", "obj": { "field1": "val111", "field2": "111" } }
  { "str": "val99", "obj": { "field1": "val99", "field2": "99" } }  
];
select from structure schema02_Table where ( 1 == 1 ) fields [ _rid, str, obj.field1, obj.field2 ];
